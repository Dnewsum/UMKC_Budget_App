// src/components/AppDownloadCard.tsx
...
export const DownloadButton: React.FC<DownloadButtonProps> = ({ href, icon, preSubtitle, subtitle }) => (
  <a
    href={href}
  ...
  >
    ...
    <div className="text-left">
      <div className="mb-1 text-xs">{preSubtitle}</div>
...
export const AppDownloadCard: React.FC = () => (
  <Card className="bg-amber-400 max-w-sm">
    ...
    <div className="items-center justify-center space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
      <DownloadButton
        href="#"
        icon={AppleIcon}
        preSubtitle="Download on the"
        subtitle="Mac App Store"
      />
      <DownloadButton
        href="#"
        icon={GooglePlayIcon}
        preSubtitle="Get in on"
